...
// values
var cameraPosition = [200, 100, 300]; //eye/camera coordinates
...
async function init() {
  ...
  var image = new Image();
  image.src = "./Common/images/robot.jpg";
